...
export function migrateTask(task: Task): Task {
  ...
  return {
    ...task,
    resultImages,
    imageModelOverride: task.imageModelOverride?.trim() || undefined,
...
export function withDefaultSkill<T extends Partial<ProjectData> & { apiBaseUrl?: string }>(state: T) {
  ...
  return {
    ...
    textToImageApiBaseUrl: (state as T & { textToImageApiBaseUrl?: string }).textToImageApiBaseUrl || '',
    ...
    imageToImageApiBaseUrl: (state as T & { imageToImageApiBaseUrl?: string }).imageToImageApiBaseUrl || '',
    ...
    textToImageApiKey: (state as T & { textToImageApiKey?: string }).textToImageApiKey || '',
    imageToImageApiKey: (state as T & { imageToImageApiKey?: string }).imageToImageApiKey || '',
